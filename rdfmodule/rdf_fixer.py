...
def csv_from_rdf(rdf_file_ok: str, rdf_file_csv: str) -> None:
    ...
    def rdf_origin(in_file: str) -> str:
        ...
        Returns:
            ...
            - "RXN:" if the file was generated by Scifinder or Infochem.
            - "ROOT:" if the file was generated by Reaxys.
        """
        f = open(in_file)
        NUMBER_OF_LINES = 12
        line: str = []
    ...
    def build_empty_table1(in_file: str, RDF_TYPE: str) -> Tuple[pd.DataFrame, int, int]:
        ...
        with open(in_file) as f:
            for line in f:
                if line.startswith("$DTYPE"):
                    ...
                    columns.append(column_name.replace(rdf_type, ""))
